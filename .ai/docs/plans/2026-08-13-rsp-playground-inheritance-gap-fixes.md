...
**Phase 2 (the real cutover — rewrite `discover-components.js`/`extract-props.js`, delete `extract-base-props.js`, widen to the full ~150-component catalog, update the GH Action) is not started yet.**
