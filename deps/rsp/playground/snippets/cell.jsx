<!-- Dev-authored, for the code disclosure AND the live RSP preview (initRsp()
     ...
     the same shared interface Column uses).

     Cell is normally used only nested inside <Row>. Loaded standalone,
     assume the same graceful-degradation behavior verified live for
     AccordionItem: some real, unstyled DOM rather than a crash. -->
