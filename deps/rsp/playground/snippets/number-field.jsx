<!-- Dev-authored, for the code disclosure AND the live RSP preview (initRsp()
     ...
     just the first letter of the whole hyphenated component name — "Number-
     field" — instead of a real label. No static-html/number-field.html
     counterpart exists yet, so there's no SWC shape to mirror.

     `label` isn't in NumberField.json's own prop list — same as TextField,
     it's inherited from the shared `LabelableProps` interface in
     rsp-base-props.json (`label: ReactNode`). -->
