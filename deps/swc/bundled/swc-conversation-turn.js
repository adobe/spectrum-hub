...
// deps/swc/swc-dist/patterns/conversational-ai/conversation-turn/conversation-turn.js
var t3 = i`:host{display:block;inline-size:100%}:host(:focus-visible){outline:none}*,*:before,*:after{box-sizing:border-box}.swc-ConversationTurn{display:flex;inline-size:100%;min-inline-size:0}.swc-ConversationTurn>slot{display:flex;flex-direction:column;gap:var(--swc-conversation-turn-group-gap, 8px);inline-size:100%;min-inline-size:0}:host([type=\"user\"]) .swc-ConversationTurn{justify-content:flex-end}:host([type=\"user\"]) .swc-ConversationTurn>slot{align-items:flex-end}:host([type=\"system\"]) .swc-ConversationTurn{justify-content:flex-start}:host([type=\"system\"]) .swc-ConversationTurn>slot{align-items:stretch}:host([type=\"system\"]) ::slotted(*){flex:1 1 100%;min-inline-size:0;max-inline-size:100%}:host(:focus-visible) ::slotted(*){outline:2px solid var(--swc-blue-800);outline-offset:2px}`;
...
// deps/swc/swc-dist/patterns/conversational-ai/conversation-turn/ConversationTurn.js
var a4 = class extends o6 {
  constructor(...e9) {
    super(...e9), this.type = "user", this.accessibleLabel = "";
  }
  static get styles() {
    return [t3];
  }
  get _turnAriaLabel() {
    return this.accessibleLabel.trim().length > 0 ? this.accessibleLabel.trim() : this.type === "user" ? "User message" : "System message";
  }
  connectedCallback() {
    super.connectedCallback(), this._applyHostSemantics();
  }
  willUpdate(e9) {
    (e9.has("type") || e9.has("accessibleLabel")) && this._applyHostSemantics();
  }
  _applyHostSemantics() {
    this.setAttribute("role", "group"), this.setAttribute("aria-label", this._turnAriaLabel);
  }
  render() {
    return b2`
...
e([n4({
  type: String,
  reflect: true
})], a4.prototype, "type", void 0), e([n4({
  type: String,
  attribute: "accessible-label"
})], a4.prototype, "accessibleLabel", void 0);

// deps/swc/swc-dist/patterns/conversational-ai/conversation-turn/index.js
e6("swc-conversation-turn", a4);
export {
  a4 as ConversationTurn
};
