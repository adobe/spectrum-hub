...
var i = (t6, ...e11) => {
  const o7 = 1 === t6.length ? t6[0] : e11.reduce((e12, s4, o8) => e12 + ((t7) => {
...
var S = (s4, o7) => {
  ...
  else for (const e11 of o7) {
    const o8 = document.createElement("style"), n6 = t.litNonce;
    void 0 !== n6 && o8.setAttribute("nonce", n6), o8.textContent = e11.cssText, s4.appendChild(o8);
  }
};
...
var y = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t6, s4, i9) {
    const { get: e11, set: r10 } = h(this.prototype, t6) ?? { get() {
      return this[s4];
    }, set(t7) {
      this[s4] = t7;
    } };
    return { get: e11, set(s5) {
      ...
      r10?.call(this, s5), this.requestUpdate(t6, h3, i9);
  ...
  _$AK(t6, s4) {
    ...
    if (void 0 !== e11 && this._$Em !== e11) {
      ...
      this._$Em = e11;
      const r10 = h3.fromAttribute(s4, t7.type);
  ...
  requestUpdate(t6, s4, i9, e11 = false, h3) {
    if (void 0 !== t6) {
      ...
      if (false === e11 && (h3 = this[t6]), i9 ??= r10.getPropertyOptions(t6), !((i9.hasChanged ?? f)(h3, s4) || i9.useDefault && i9.reflect && h3 === this._$Ej?.get(t6) && !this.hasAttribute(r10._$Eu(t6, i9)))) return;
      this.C(t6, s4, i9);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t6, s4, { useDefault: i9, reflect: e11, wrapped: h3 }, r10) {
    i9 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t6) && (this._$Ej.set(t6, r10 ?? s4 ?? this[t6]), true !== h3 || void 0 !== r10) || (this._$AL.has(t6) || (this.hasUpdated || i9 || (s4 = void 0), this._$AL.set(t6, s4)), true === e11 && this._$Em !== t6 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t6));
  }
  async _$EP() {
...
var N = (t6, i9) => {
  ...
  for (let i10 = 0; i10 < s4; i10++) {
    const s5 = t6[i10];
    let a5, u4, d4 = -1, f3 = 0;
    for (; f3 < s5.length && (c4.lastIndex = f3, u4 = c4.exec(s5), null !== u4); ) f3 = c4.lastIndex, c4 === v ? "!--" === u4[1] ? c4 = _ : void 0 !== u4[1] ? c4 = m : void 0 !== u4[2] ? (y2.test(u4[2]) && (n6 = RegExp("</" + u4[2], "g")), c4 = p2) : void 0 !== u4[3] && (c4 = p2) : c4 === p2 ? ">" === u4[0] ? (c4 = n6 ?? v, d4 = -1) : void 0 === u4[1] ? d4 = -2 : (d4 = c4.lastIndex - u4[2].length, a5 = u4[1], c4 = void 0 === u4[3] ? p2 : '"' === u4[3] ? $ : g) : c4 === $ || c4 === g ? c4 = p2 : c4 === _ || c4 === m ? c4 = v : (c4 = p2, n6 = void 0);
    const x2 = c4 === p2 && t6[i10 + 1].startsWith("/>") ? " " : "";
    l3 += c4 === v ? s5 + r3 : d4 >= 0 ? (e11.push(a5), s5.slice(0, d4) + h2 + s5.slice(d4) + o3 + x2) : s5 + o3 + (-2 === d4 ? i10 : x2);
  }
...
var S2 = class _S {
  constructor({ strings: t6, _$litType$: i9 }, e11) {
    ...
    for (; null !== (r10 = P.nextNode()) && d4.length < u4; ) {
      if (1 === r10.nodeType) {
        if (r10.hasAttributes()) for (const t7 of r10.getAttributeNames()) if (t7.endsWith(h2)) {
          const i10 = v2[a5++], s4 = r10.getAttribute(t7).split(o3), e12 = /([.?@])?(.*)/.exec(i10);
          d4.push({ type: 1, index: l3, name: e12[2], strings: s4, ctor: "." === e12[1] ? I : "?" === e12[1] ? L : "@" === e12[1] ? z : H }), r10.removeAttribute(t7);
        } else t7.startsWith(o3) && (d4.push({ type: 6, index: l3 }), r10.removeAttribute(t7));
        if (y2.test(r10.tagName)) {
          const t7 = r10.textContent.split(o3), i10 = t7.length - 1;
          if (i10 > 0) {
            r10.textContent = s2 ? s2.emptyScript : "";
            for (let s4 = 0; s4 < i10; s4++) r10.append(t7[s4], c3()), P.nextNode(), d4.push({ type: 2, index: ++l3 });
            r10.append(t7[i10], c3());
          }
        }
      } else if (8 === r10.nodeType) if (r10.data === n3) d4.push({ type: 2, index: l3 });
      else {
        let t7 = -1;
        for (; -1 !== (t7 = r10.data.indexOf(o3, t7 + 1)); ) d4.push({ type: 7, index: l3 }), t7 += o3.length - 1;
      }
      l3++;
    }
  }
...
function M(t6, i9, s4 = t6, e11) {
  ...
  const o7 = a2(i9) ? void 0 : i9._$litDirective$;
  return h3?.constructor !== o7 && (h3?._$AO?.(false), void 0 === o7 ? h3 = void 0 : (h3 = new o7(t6), h3._$AT(t6, s4, e11)), void 0 !== e11 ? (s4._$Co ??= [])[e11] = h3 : s4._$Cl = h3), void 0 !== h3 && (i9 = M(t6, h3._$AS(t6, i9.values), h3, e11)), i9;
}
var R = class {
  constructor(t6, i9) {
  ...
  u(t6) {
    ...
    P.currentNode = e11;
    let h3 = P.nextNode(), o7 = 0, n6 = 0, r10 = s4[0];
    for (; void 0 !== r10; ) {
      if (o7 === r10.index) {
        let i10;
        2 === r10.type ? i10 = new k(h3, h3.nextSibling, this, t6) : 1 === r10.type ? i10 = new r10.ctor(h3, r10.name, r10.strings, this, t6) : 6 === r10.type && (i10 = new Z(h3, this, t6)), this._$AV.push(i10), r10 = s4[++n6];
      }
      o7 !== r10?.index && (h3 = P.nextNode(), o7++);
    }
...
var H = class {
  ...
  _$AI(t6, i9 = this, s4, e11) {
    ...
    let o7 = false;
    if (void 0 === h3) t6 = M(this, t6, i9, 0), o7 = !a2(t6) || t6 !== this._$AH && t6 !== E, o7 && (this._$AH = t6);
    else {
      const e12 = t6;
      let n6, r10;
      for (t6 = h3[0], n6 = 0; n6 < h3.length - 1; n6++) r10 = M(this, e12[s4 + n6], i9, n6), r10 === E && (r10 = this._$AH[n6]), o7 ||= !a2(r10) || r10 !== this._$AH[n6], r10 === A ? t6 = A : t6 !== A && (t6 += (r10 ?? "") + h3[n6 + 1]), this._$AH[n6] = r10;
    }
    o7 && !e11 && this.j(t6);
  }
  j(t6) {
...
var i4 = class extends y {
  ...
  update(t6) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t6), this._$Do = D(r10, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
// deps/swc/swc-dist/components/tabs/tab.js
var t3 = i`:host{display:inline-flex;align-self:start;justify-self:start;place-self:start;outline:none}*,*:before,*:after{box-sizing:border-box}.swc-Tab{--_swc-tab-text-color: var(--swc-tab-text-color, var(--swc-gray-700));display:inline-flex;position:relative;gap:6px;align-items:center;justify-content:center;block-size:var(--swc-tab-height, var(--swc-tab-item-height-medium));padding-block:var(--swc-tab-padding-block, 7px) var(--swc-tab-padding-block-end, 8px);color:var(--_swc-tab-text-color);overflow:clip;-webkit-user-select:none;-moz-user-select:none;user-select:none}.swc-Tab-label{font-size:var(--swc-font-size-100);font-weight:400;line-height:1.3}::slotted([slot=\"icon\"]){display:grid;flex-shrink:0;align-content:center;justify-content:center;place-content:center;inline-size:var(--swc-workflow-icon-medium);block-size:var(--swc-workflow-icon-medium)}:host([selected]){--swc-tab-text-color: var(--swc-gray-800)}:host(:hover){--swc-tab-text-color: var(--swc-gray-800)}:host(:active){--swc-tab-text-color: var(--swc-gray-800)}:host([disabled]){--swc-tab-text-color: var(--swc-gray-400)}:host(:focus-visible) .swc-Tab{border-radius:4px;outline:2px solid var(--swc-blue-800);outline-offset:2px}@media(forced-colors:active){:host{--swc-tab-text-color: ButtonText}:host([selected]){--swc-tab-text-color: Highlight}:host([disabled]){--swc-tab-text-color: GrayText}:host(:focus-visible) .swc-Tab{outline-color:Highlight}}`;

// deps/swc/swc-dist/core/_virtual/_@oxc-project_runtime@0.124.0/helpers/decorate.js
function e4(e11, t6, n6, r10) {
  var i9 = arguments.length, a5 = i9 < 3 ? t6 : r10 === null ? r10 = Object.getOwnPropertyDescriptor(t6, n6) : r10, o7;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") a5 = Reflect.decorate(e11, t6, n6, r10);
  else for (var s4 = e11.length - 1; s4 >= 0; s4--) (o7 = e11[s4]) && (a5 = (i9 < 3 ? o7(a5) : i9 > 3 ? o7(t6, n6, a5) : o7(t6, n6)) || a5);
  return i9 > 3 && a5 && Object.defineProperty(t6, n6, a5), a5;
}

// node_modules/@lit/reactive-element/decorators/property.js
var o5 = { attribute: true, type: String, converter: u, reflect: false, hasChanged: f };
var r4 = (t6 = o5, e11, r10) => {
  const { kind: n6, metadata: i9 } = r10;
  let s4 = globalThis.litPropertyMetadata.get(i9);
  if (void 0 === s4 && globalThis.litPropertyMetadata.set(i9, s4 = /* @__PURE__ */ new Map()), "setter" === n6 && ((t6 = Object.create(t6)).wrapped = true), s4.set(r10.name, t6), "accessor" === n6) {
    const { name: o7 } = r10;
    return { set(r11) {
      const n7 = e11.get.call(this);
      e11.set.call(this, r11), this.requestUpdate(o7, n7, t6, true, r11);
    }, init(e12) {
      return void 0 !== e12 && this.C(o7, void 0, t6, e12), e12;
    } };
  }
  if ("setter" === n6) {
    const { name: o7 } = r10;
    return function(r11) {
      const n7 = this[o7];
      e11.call(this, r11), this.requestUpdate(o7, n7, t6, true, r11);
    };
  }
  throw Error("Unsupported decorator location: " + n6);
};
function n4(t6) {
  return (e11, o7) => "object" == typeof o7 ? r4(t6, e11, o7) : ((t7, e12, o8) => {
    const r10 = e12.hasOwnProperty(o8);
    return e12.constructor.createProperty(o8, t7), r10 ? Object.getOwnPropertyDescriptor(e12, o8) : void 0;
  })(t6, e11, o7);
}
...
if (i5 = o6, i5.VERSION = e7, i5.CORE_VERSION = t4, true) {
  ...
  window.__swc = {
    ...
    warn: (e12, t7, n6, { type: r10 = "api", level: i9 = "default", issues: a5 } = {}) => {
      let { localName: o7 = "base" } = e12 || {}, s5 = `${o7}:${r10}:${i9}`;
      if (!window.__swc.verbose && window.__swc.issuedWarnings.has(s5) || window.__swc.ignoreWarningLocalNames[o7] || window.__swc.ignoreWarningTypes[r10] || window.__swc.ignoreWarningLevels[i9]) return;
...
var d3 = class e10 extends o6 {
  constructor(...t6) {
    super(...t6), this._keyboardActivation = r8, this._density = a4, this._direction = t5, this.disabled = false, this.accessibleLabel = "", this.selected = "", this.selectionIndicatorStyle = "", this.shouldAnimate = false, this._tabs = [], this.updateSelectionIndicator = async () => {
      var t7, n6;
      let r10 = this._tabs.find((e11) => e11.selected);
      if (!r10) {
      ...
      if (!i9) return;
      await Promise.all([(n6 = r10.updateComplete) == null ? Promise.resolve() : n6, document.fonts ? document.fonts.ready : Promise.resolve()]);
      let a5 = r10.getBoundingClientRect(), o7 = i9.getBoundingClientRect();
      this._direction === "horizontal" ? this.selectionIndicatorStyle = `transform: translateX(${a5.left - o7.left}px) scaleX(${a5.width / e10.INDICATOR_BASE_SIZE})` : this.selectionIndicatorStyle = `transform: translateY(${a5.top - o7.top}px) scaleY(${a5.height / e10.INDICATOR_BASE_SIZE})`, this.shouldAnimate || (await this.updateComplete, this.shouldAnimate = true);
    };
  }
  ...
  set keyboardActivation(e11) {
    ...
    !i9 && (r10 = window.__swc) != null && r10.DEBUG && window.__swc.warn(this, `<${this.localName}> expects "keyboard-activation" to be one of:`, "https://opensource.adobe.com/spectrum-web-components/components/tabs/", { issues: [...n5] });
    let a5 = i9 ? e11 : r8;
    if (this._keyboardActivation === a5) return;
    let o7 = this._keyboardActivation;
    this._keyboardActivation = a5, this.requestUpdate("keyboardActivation", o7);
  }
  get density() {
  ...
  set density(e11) {
    ...
    let r10 = n6 ? e11 : a4;
    if (this._density === r10) return;
    let i9 = this._density;
    this._density = r10, this.requestUpdate("density", i9);
  }
  get direction() {
  ...
  set direction(e11) {
    ...
    let a5 = n6 ? e11 : t5;
    if (this._direction === a5) return;
    let o7 = this._direction;
    this._direction = a5, this.requestUpdate("direction", o7);
  }
  ...
  focusByDelta(e11) {
    ...
    let t6 = this.getRootNode(), n6 = this._tabs.indexOf(t6.activeElement), r10 = n6 === -1 ? 0 : n6, i9 = this.wrapIndex(r10 + e11);
  ...
  managePanels(e11) {
    for (let t6 of e11) {
      let { tabId: e12, id: n6 } = t6, r10 = this.querySelector(`[role="tab"][tab-id="${e12}"]`);
      r10 && (r10.setAttribute("aria-controls", n6), t6.setAttribute("aria-labelledby", r10.id)), t6.selected = e12 === this.selected;
    }
  }
  willUpdate(e11) {
    if (!this.hasUpdated) {
...
// deps/swc/swc-dist/components/tabs/Tab2.js
var r9 = class extends i6 {
  static get styles() {
    return [t3];
  }
  render() {
...
// deps/swc/swc-dist/components/tabs/swc-tab.js
e6("swc-tab", r9);
