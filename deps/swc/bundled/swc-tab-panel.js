...
// deps/swc/swc-dist/components/tabs/tab-panel.js
var t3 = i`:host{display:block;padding-block-start:var(--swc-tab-panel-padding-top, 12px)}:host([aria-hidden=\"true\"]){display:none}@media(forced-colors:active){:host{color:CanvasText}}`;
...
// deps/swc/swc-dist/components/tabs/TabPanel.js
var r9 = class extends i7 {
  static get styles() {
    return [t3];
  }
  render() {
...
// deps/swc/swc-dist/components/tabs/swc-tab-panel.js
e6("swc-tab-panel", r9);
